    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-950">
      <div className="w-full max-w-md p-8 rounded-3xl border border-slate-800 bg-slate-900/70 backdrop-blur-xl shadow-2xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-xl font-extrabold tracking-tight text-slate-100">Create Account</h1>
          <p className="text-xs text-slate-400">Get started with AI Interview Intelligence</p>
        </div>
